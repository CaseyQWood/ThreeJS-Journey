...
const positions = new Float32Array(count * 3) // the multiply is cause each possition is composed of 3 values (x,y,z)
...
// particlesMaterial.alphaTest = 0.001 // this cleans out the left over background
